...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    receive: {
        title: 'Получить',
        subtitle: 'Отправляйте на этот адрес только активы из TON Blockchain. Другие активы будут потеряны навсегда',
        share: {
    ...
    transfer: {
        ...
        error: {
            ...
            notEnoughCoins: 'На вашем балансе недостаточно монет',
