...
export const LiquidWithdrawActionFragment = fragment(() => {
  ...
  return (
    <View
      ...
      />
      {Platform.OS === 'android' && <ScreenHeader onClosePressed={navigation.goBack} />}
      {Platform.OS === 'ios' && <View style={{ flexGrow: 1 }} />}
      <View
        style={[
          {
        ...
        <Text
          ...
          <Text style={{ color: theme.accent }}>{'DeDust.io'}</Text>
        </Text>
        {Platform.OS === 'android' && <View style={{ flexGrow: 1 }} />}
        <RoundButton
        ...
        <RoundButton
          ...
          display={'secondary'}
          onPress={() => {
            navigation.navigateLiquidStakingTransfer({ action: 'withdraw' }, { replace: true });
          }}
        />
      </View>
    </View>
