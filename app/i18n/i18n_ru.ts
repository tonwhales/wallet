...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    "settings": {
        "title": "Ещё",
        "backupKeys": "Сохранить секретный ключ",
    ...
    "products": {
        ...
        "staking": {
            ...
            "pools": {
                ...
                "teamBannerDescription": "Если вы не являетесь сотрудником Ton Whales или одним из ТОП 15 членов нашего клуба, ваши средства, внесенные на счет, будут храниться на балансе стейкинг пула, но не будут участвовать в стейкинге",
    ...
    "welcome": {
        ...
        "slide_1": {
            "title": "Безопасный",
            "subtitle": "Надежный смарт-контракт, Touch/Face ID, пароль и все это в децентрализованной блокчейн сети"
        },
        "slide_2": {
            "title": "Уникальная криптокарта",
    ...
    "legal": {
        ...
        "createSubtitle": "Не передавайте ваш секретный ключ третьим лицам и храните только в надежном месте. Seed-фраза - это единственный способ получить доступ к вашему кошельку, если устройство  будет потеряно.",
    ...
    "security": {
        "title": "Безопасность",
        "passcodeSettings": {
            "setupTitle": "Установить пароль",
            "confirmTitle": "Подтвердить пароль",
            "changeTitle": "Изменить пароль",
            "resetTitle": "Сбросить пароль",
            "resetDescription": "Вы можете сбросить пароль, введя 24 секретных слова, которые вы записали при создании кошелька.",
            ...
            "changeLength": "Использовать {{length}}-значный пароль",
            "forgotPasscode": "Забыли пароль?",
            "logoutAndReset": "Выйти и сбросить пароль"
        },
        "auth": {
    ...
    "logout": {
        ...
        "logoutDescription": "Доступ к кошельку будет потерян. Вы сохранили свой секретный ключ?"
    },
    "contacts": {
        "title": "Контакты",
        "contact": "Контакт",
