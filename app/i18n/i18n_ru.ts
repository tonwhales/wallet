...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    "browser": {
        ...
        "alertModal": {
            "message": "Вы собираетесь открыть стороннее веб-приложение, которое не является частью нашего приложения. Взаимодействуя с ними, вы соглашаетесь с условиями и политикой конфиденциальности соответствующих сторонних сторон.",
            "action": "Открыть"
        }
    },
    "swap": {
