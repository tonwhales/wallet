...
import { useAppData, useAppManifest, useClient4, useCommitCommand, useNetwork, useNewAddressFormat, useRegisterPending, useSelectedAccount, useServerConfig, useTheme } from "../../../engine/hooks";
                        ...
                        <View style={{ paddingHorizontal: 10, justifyContent: 'center' }}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={{ fontSize: 17, fontWeight: '400', lineHeight: 24, color: theme.textPrimary }}>
                                    <AddressComponent address={selected!.address} bounceable={!newFormat} end={4} />
                                </Text>
                                {walletSettings?.name && (
                                    <Text
                                        style={{
