...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    "transfer": {
        ...
        "error": {
            ...
            "gaslessCooldown": "Вы можете оплатить комиссию токеном раз в несколько минут. Пожалуйста, подождите или оплатите комиссию в GRAM.",
            "gaslessCooldownTitle": "Подождите несколько минут перед следующей транзакцией",
            "gaslessCooldownWait": "Подожду",
            "gaslessCooldownPayTon": "Оплатить комиссию в GRAM",
            ...
            "notEnoughGasTitle": "Недостаточно GRAM для оплаты комиссии",
            "notEnoughGasMessage": "Пожалуйста, пополните кошелек GRAM (необходимо еще как минимум {{diff}} GRAM) и попробуйте снова",
        },
        ...
        "unusualJettonsGasTitle": "Gas за отправку токенов {{amount}} GRAM",
    ...
    "products": {
        ...
        "staking": {
            ...
            "pools": {
                ...
                "epnPartnersDescription": "Для вебмастеров, работающих с ePN и получающих оплату в GRAM",
                ...
                "liquidDescription": 'Отправьте GRAM на стейкинг и получите токены wsTON взамен',
            ...
            "transfer": {
                ...
                "notEnoughCoinsFee": "На балансе вашего кошелька недостаточно средств для оплаты комиссии. Обратите внимание, что сумма комиссии {{amount}} GRAM должна находиться на основном балансе, а не на балансе стейкинга",
            ...
            "join": {
                ...
                "successTitle": "Отправлено {{amount}} GRAM",
                "successEtimation": "Ваш предполагаемый годовой доход составляет {{amount}} GRAM (${{price}}).",
                "successNote": "Ваш застейканый GRAM будет активен после начала следующего цикла."
            },
            "pool": {
            ...
            "unstakeLiquid": {
                "title": "Вывести wsTON",
                "message": "Вы можете вывести средства непосредственно после завершения цикла или мгновенно обменять wsTON на GRAM на "
            },
            "unstakeLiquidUsde": {
            ...
            "info": {
                ...
                "depositFeeDescription": "Мы вычтем из суммы вашего депозита {{amount}} GRAM, которые потребуются для проведения операции в блокчейне. Остаток этой суммы вернется на баланс вашего кошелька",
            ...
            "minAmountWarning": "Минимальное количество {{minAmount}} GRAM",
            "tryAgainLater": "Пожалуйста, повторите попытку позже",
            "banner": {
                "estimatedEarnings": "Ваш предполагаемый годовой доход уменьшится на {{amount}} GRAM (${{price}})",
        ...
        "holders": {
            ...
            "accounts": {
                ...
                "vestingName": "Трастовый счет {{accountIndex}}",
                "vestingPrimaryName": "Трастовый счет",
                "topUp": "Пополнить счёт",
                "addNew": "Добавить счёт",
                "network": "Сеть {{networkName}}",
            },
            "physicalCard": {
                "supportMessage": "Здравствуйте, у меня вопрос по доставке моей физической карты Holders.",
            },
            "pageTitles": {
            ...
            "card": {
                ...
                "defaultSubtitle": "Платите USDT и GRAM везде с картой Tonhub",
            ...
            "dogsInvite": {
                "title": "Начните с вашей карты DOGS",
                "subtitle": "Вы можете открыть карту DOGS здесь и пополнить её напрямую с помощью DOGS. Быстрая настройка, простое пополнение — всё в одном месте."
            }
        }
    },
    "welcome": {
        ...
        "slide_2": {
            "title": "Удобный",
            "subtitle": "Платите GRAM везде с уникальной криптокартой, привязанной прямо к вашему некастодиальному кошельку "
        },
        "slide_3": {
            "title": "Быстрый",
    ...
    "neocrypto": {
        ...
        "title": "Покупайте GRAM с помощью кредитной карты за доллары США или евро",
    ...
    "known": {
        ...
        "withdraw": "Запрос вывода {{coins}} GRAM",
        ...
        "holders": {
            ...
            "accountTopUp": "Пополнение на {{amount}} GRAM",
    ...
    "spamFilter": {
        "minAmount": "Минимальная сумма GRAM",
        "dontShowComments": "Не показывать комментарии на SPAM транзакциях",
        "minAmountDescription": "Транзакции с количеством GRAM меньшим, чем {{amount}} будут автоматически помечаться как SPAM",
    ...
    "deleteAccount": {
        ...
        "description": "Это действие удалит все данные, выбранный кошелек и вашу учетную запись в блокчейне с этого устройства\nВы должны перевести все свои монеты GRAM на другой кошелек. Прежде чем продолжить, убедитесь, что на вашем счету есть более {{amount}} GRAM для завершения транзакции",
        ...
        "confirm": {
            ...
            "message": "Это действие приведет к удалению вашего аккаунта и всех данных из приложения и переведет все GRAM на кошелек с указанным адресом.\nПожалуйста, проверьте адрес кошелька перед продолжением. Стандартная комиссия за транзакцию взымается в данной операции."
        },
    ...
    "txActions": {
        ...
        "viewInExplorer": "Посмотреть в эксплорере",
    ...
    "newAddressFormat": {
        ...
        "description_3": 'Все GRAM, жетоны, NFT и другие токены, отправленные по старому адресу, продолжат поступать в ваш кошелек без изменений.',
    ...
    "w5": {
        ...
        "update": {
            ...
            "description_1": "Вам больше не нужен GRAM для отправки USDT. Транзакционные сборы могут быть покрыты с вашего баланса токенов.",
        ...
        "gaslessInfo": "GRAM не требуется для оплаты комиссии за газ при отправке этого токена. Комиссия будет удержана непосредственно из вашего баланса данного токена."
    },
    "browser": {
        "listings": {
            "categories": {
