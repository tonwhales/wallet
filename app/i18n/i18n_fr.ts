...
const schema: PrepareSchema<LocalizationSchema, "" | "_plural"> = {
    ...
    "common": {
        ...
        "moreAbout": "En savoir plus sur {{name}}"
    },
    "syncStatus": {
    ...
    "receive": {
        "title": "Recevoir",
        "subtitleTon": "Envoyez uniquement des Gram et des jetons sur le réseau TON à cette adresse, sinon vous risquez de perdre vos fonds.",
    ...
    "transfer": {
        ...
        "error": {
            ...
            "gaslessCooldown": "Vous ne pouvez payer les frais de réseau en jetons qu'une fois toutes les quelques minutes. Veuillez patienter ou payer les frais en GRAM.",
            "gaslessCooldownTitle": "Attendez quelques minutes avant la prochaine transaction",
            "gaslessCooldownWait": "Je vais attendre",
            "gaslessCooldownPayTon": "Payer le gaz en GRAM",
            ...
            "ledgerErrorConnectionTitle": "Ledger n'est pas connecté",
            "ledgerErrorConnectionMessage": "Veuillez connecter Ledger et réessayer",
            "notEnoughGasTitle": "GRAM insuffisant pour couvrir les frais de gaz",
            "notEnoughGasMessage": "Veuillez recharger votre portefeuille avec GRAM (au moins {{diff}} GRAM de plus est nécessaire) et réessayer"
        },
        ...
        "unusualJettonsGasTitle": "Les frais d'envoi de jetons sont de {{amount}} GRAM",
        ...
        "solana": {
            "error": {
                ...
                "signingFailed": "Erreur de signature de la transaction",
                "insufficientFundsForRentTitle": "Montant de la transaction inférieur au minimum",
                "insufficientFundsForRent": "Fonds SOL insuffisants pour envoyer à: {{address}}, besoin de {{amount}} de plus",
                "blockhashExpired": "La transaction a expiré, veuillez réessayer",
                "accountNotFound": "Compte du destinataire introuvable",
                "accountNotInitialized": "Le compte du destinataire n'a pas encore été activé sur le réseau",
                "insufficientFundsForFee": "Fonds SOL insuffisants pour les frais de transaction",
                "customProgramError": "Erreur du programme (code: {{code}})",
                "transactionTooLarge": "La transaction est trop volumineuse",
                "duplicateTransaction": "Cette transaction a déjà été traitée",
                "simulationFailed": "La simulation de la transaction a échoué",
    ...
    "sign": {
        ...
        "cellSchema": "Schéma de cellule",
        "cellData": "Données de cellule"
    },
    "migrate": {
    ...
    "qr": {
        ...
        "galleryPermissionMessage": "Pour scanner les codes QR à partir de vos photos, l'application a besoin d'accéder à votre galerie"
    },
    "products": {
        ...
        "staking": {
            ...
            "pools": {
                ...
                "liquidDescription": "Envoyez du GRAM en staking et recevez à la place des wsTON",
            ...
            "transfer": {
                ...
                "notEnoughCoinsFee": "Vous n'avez pas assez de GRAM sur le solde de votre portefeuille pour payer les frais. Veuillez noter que les {{amount}} GRAM de frais doivent être sur le solde principal, et non sur le solde de staking",
            ...
            "join": {
                ...
                "earn": "Gagnez jusqu'à",
                "onYourTons": "sur vos GRAM",
                "apy": "13.3%",
                "yearly": "Rendement annuel",
                "cycle": "Recevez vos récompenses de staking toutes les 36h",
                "ownership": "Les GRAM stakés restent à vous",
                "withdraw": "Retirez et rechargez à tout moment",
                "successTitle": "{{amount}} GRAM stakés",
                "successEtimation": "Vos gains annuels estimés sont de {{amount}}\u00A0GRAM\u00A0(${{price}}).",
                "successNote": "Vos GRAM stakés seront activés au début du prochain cycle."
            },
            "pool": {
                "balance": "Mise Totale",
                "members": "Nominateurs",
            ...
            "unstakeLiquid": {
                ...
                "message": "Vous pouvez retirer les fonds directement après la fin du cycle ou échanger instantanément wsTON contre GRAM sur "
            },
            "unstakeLiquidUsde": {
            ...
            "info": {
                ...
                "depositFeeDescription": "Montant GRAM qui sera déduit du dépôt pour couvrir les frais d'action de dépôt; le montant inutilisé vous sera retourné",
                "withdrawFeeDescription": "Montant du transfert GRAM nécessaire pour couvrir les frais d'action de retrait; le montant inutilisé vous sera retourné",
                "withdrawCompleteDescription": "Montant du transfert GRAM nécessaire pour couvrir les frais de finalisation du retrait; le montant inutilisé vous sera retourné",
            ...
            "minAmountWarning": "Le montant minimal est {{minAmount}} GRAM",
            "tryAgainLater": "Veuillez réessayer plus tard",
            "banner": {
                "estimatedEarnings": "Vos gains annuels estimés diminueront de {{amount}}\u00A0GRAM\u00A0({{price}})",
        ...
        "holders": {
            ...
            "physicalCard": {
                "supportMessage": "Bonjour, j'ai une question concernant la livraison de ma carte physique Holders.",
            },
            "pageTitles": {
            ...
            "card": {
                ...
                "defaultSubtitle": "Payez partout avec USDT ou GRAM par carte",
            ...
            "banner": {
                ...
                "dogsTitle": "DOGS maintenant supporté",
                "dogsSubtitle": "Rechargez facilement votre carte avec DOGS",
            },
            "dogsbanner": {
                "subtitle": "Personnalisez votre carte avec DOGS et payez dans le monde entier avec des fonctionnalités supplémentaires.",
                "action": "Personnaliser votre carte",
            },
            "transaction": {
                "type": {
            ...
            "dogsInvite": {
                "title": "Commencez avec votre carte DOGS",
                "subtitle": "Vous pouvez ouvrir votre carte DOGS ici et la recharger directement avec des DOGS. Configuration rapide, financement facile — tout en un seul endroit."
            }
        }
    },
    "welcome": {
    ...
    "neocrypto": {
        ...
        "title": "Acheter GRAM avec carte de crédit (USD, EUR et RUB)",
    ...
    "known": {
        ...
        "withdraw": "Demande de retrait de {{coins}} GRAM",
        ...
        "holders": {
            ...
            "accountTopUp": "Recharge de {{amount}} GRAM",
    ...
    "spamFilter": {
        "minAmount": "Montant MIN GRAM",
        "dontShowComments": "Ne pas afficher les commentaires des transactions SPAM",
        "minAmountDescription": "Les transactions avec un montant inférieur à {{amount}} GRAM seront automatiquement marquées comme SPAM",
    ...
    "deleteAccount": {
        ...
        "description": "Cette action supprimera toutes les données et le portefeuille sélectionné de cet appareil et votre compte blockchain.\nVous devez transférer tous vos coins GRAM vers un autre portefeuille. Avant de continuer, assurez-vous d'avoir suffisamment de GRAM (plus de {{amount}}) pour finaliser la transaction.",
        ...
        "confirm": {
            ...
            "message": "Cette action supprimera votre compte et toutes les données de l'application et transférera tous vos coins GRAM vers l'adresse spécifiée.\nVérifiez bien l'adresse de réception. Des frais de blockchain standard seront appliqués."
        },
    ...
    "hardwareWallet": {
        ...
        "verifyAddress": {
            "title": "Confirmer l'adresse sur Ledger",
            "message": "Veuillez confirmer l'adresse : {{address}} sur votre appareil Ledger",
            "action": "Confirmer",
            "invalidAddressTitle": "Adresse invalide",
            "invalidAddressMessage": "Cette adresse n'est pas valide. Veuillez vérifier l'adresse et réessayer",
            "failed": "Échec de la vérification de l'adresse",
            "failedMessage": "Veuillez reconnecter Ledger et réessayer",
            "verifying": "Confirmer sur Ledger",
            "validAddressTitle": "Cette adresse est valide"
        }
    },
    "devTools": {
    ...
    "newAddressFormat": {
        ...
        "description_3": "Tous les GRAM, tokens, NFT et autres actifs envoyés à votre ancienne adresse arriveront toujours sur votre portefeuille.",
    ...
    "w5": {
        ...
        "update": {
            ...
            "description_1": "Vous n'avez plus besoin de GRAM pour envoyer des USDT. Les frais sont déduits de votre solde en tokens.",
        ...
        "gaslessInfo": "GRAM n'est pas nécessaire pour les frais de gaz en envoyant ce token : ils sont déduits directement de votre solde en tokens."
    },
    "browser": {
        "listings": {
            "categories": {
    ...
    "update": {
        ...
        "forceDescription": "Cette version de Tonhub n'est plus prise en charge. Mettez à jour l'application pour continuer.",
        "forceSupport": "Contacter le support"
    },
    "savings": {
        "ton": "Compte d'épargne GRAM",
        "usdt": "Compte d'épargne USDT",
        "general": "Compte d'épargne {{symbol}}"
    },
    "spending": {
        "ton": "Compte de dépenses GRAM",
        "usdt": "Compte de dépenses USDT",
        "general": "Compte de dépenses {{symbol}}"
    },
    "solana": {
        "instructions": {
            "createAssociatedTokenAccount": "Créer ATA",
            ...
            "executeWithdrawal": "Exécuter le retrait",
            "cancelWithdrawal": "Annuler le retrait",
            "allocateWithdrawals": "Allouer les retraits",
            "deleteCard": "Supprimer la carte",
            "updateCardStateV2": "Mettre à jour l'état de la carte",
            "createRoot": "Créer root",
            "issueCard": "Émettre une carte",
            "refund": "Remboursement",
            "syncCardBalance": "Synchroniser le solde de la carte",
            "updateCardState": "Mettre à jour l'état de la carte",
            "withdrawFromTreasure": "Retirer du trésor",
            "addToWhitelist": "Ajouter à la liste blanche",
            "removeFromWhitelist": "Retirer de la liste blanche",
            "resetWhitelist": "Réinitialiser la liste blanche",
            "changeController": "Changer le contrôleur",
            "changeGracefulPeriod": "Changer la période de grâce",
            "assignNewTreasureAuthority": "Attribuer une nouvelle autorité du trésor",
            "setSupportAuthority": "Définir l'autorité de support",
            "setWithdrawalConfig": "Définir la configuration de retrait",
            "fixIncorrectDeposit": "Corriger le dépôt incorrect",
            "instruction-12": "Transfert"
        },
        "banner": {
            "title": "Solana est maintenant disponible",
            "description": "Recevez, stockez et envoyez SOL et USDC"
        }
    },
    "iban": {
        "banner": {
    ...
    "aiChat": {
        ...
        "welcomeTitle": "Bienvenue dans le chat IA !",
        "welcomeSubtitle": "Posez des questions sur vos dépenses ou demandez des conseils",
        "placeholder": "Tapez un message...",
        "characterCount": "{{count}}/1000",
        "recoveringRequest": "Récupération de la demande...",
        "clearHistory": "Effacer l'historique",
        "reconnect": "Reconnecter",
        "messageTooLong": "Message trop long. Maximum 1000 caractères autorisés.",
        "notConnected": "Non connecté au serveur de chat",
        "loadingProfile": "Chargement du profil...",
        "profileNotAvailable": "Profil non disponible. Vérifiez votre compte Holders.",
        "errors": {
            "certificateError": "Échec de la validation du certificat. Vérifiez la configuration SSL du serveur.",
        ...
        "tx": {
            "categories": {
                ...
                "home_and_utilities": "Maison et services publics",
                "professional_services": "Services professionnels",
                "public_administrations": "Administrations publiques",
                ...
                "purchase": "Achat",
                "general": "Général",
                "purchase_reversal": "Remboursements",
                "deposit": "Dépôt",
                "other": "Autre"
            }
        }
