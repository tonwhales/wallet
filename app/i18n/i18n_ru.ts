...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    legal: {
        ...
        createSubtitle: 'Запишите секретный ключ, храните его в надежном месте и никогда не сообщайте его никому. Это единственный способ восстановить доступ к вашему кошельку, если вы потеряете свое устройство',
