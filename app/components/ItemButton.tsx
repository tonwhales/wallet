        ...
        <Pressable style={(props) => ({ opacity: props.pressed ? 0.3 : 1, flexDirection: 'row', alignItems: 'center' })} onPress={props.onPress}>
            <View style={{
                ...
                <View style={{ flexGrow: 1, flexShrink: 1, flexDirection: 'row', alignItems: 'center' }}>
                    {props.leftIcon && (<Image style={{ height: 24, width: 24, tintColor: props.dangerZone ? theme.dangerZone : theme.textPrimary }} source={props.leftIcon} />)}
                    ...
                    <Text
                        style={{
                            ...
                            color: props.dangerZone ? theme.dangerZone : theme.textPrimary,
                            marginLeft: 13,
                            lineHeight: 24,
                        }}
                        numberOfLines={1}
