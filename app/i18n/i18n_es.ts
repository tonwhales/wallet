...
const schema: PrepareSchema<LocalizationSchema, "" | "_plural"> = {
    ...
    "receive": {
        "title": "Recibir",
        "subtitleTon": "Envía solo Gram y tokens en la red TON a esta dirección, o podrías perder tus fondos.",
        ...
        "fromExchange": "Depositar desde un intercambio",
        "fromAnotherWallet": "Depositar desde otra billetera",
    ...
    "transfer": {
        ...
        "error": {
            ...
            "gaslessCooldown": "Solo puedes pagar la tarifa de gas en la moneda del token una vez cada pocos minutos. Por favor espera o paga la tarifa de transacción en GRAM.",
            "gaslessCooldownTitle": "Espera unos minutos antes de la próxima transacción",
            "gaslessCooldownWait": "Esperaré",
            "gaslessCooldownPayTon": "Pagar gas en GRAM",
            ...
            "ledgerErrorConnectionTitle": "Ledger no está conectado",
            "ledgerErrorConnectionMessage": "Por favor, conecte su Ledger y vuelva a intentarlo",
            "notEnoughGasTitle": "No tienes suficientes GRAM para cubrir la tarifa de gas",
            "notEnoughGasMessage": "Por favor recarga tu billetera con GRAM (se necesita al menos {{diff}} GRAM más) e intenta de nuevo"
        },
        ...
        "unusualJettonsGasTitle": "La tarifa por enviar tokens es de {{amount}} GRAM",
        ...
        "solana": {
            "error": {
                ...
                "signingFailed": "Error al firmar la transacción",
                "insufficientFundsForRentTitle": "Cantidad de transacción por debajo del mínimo",
                "insufficientFundsForRent": "Fondos SOL insuficientes para enviar a: {{address}}, se necesita {{amount}} más",
                "blockhashExpired": "La transacción ha expirado, inténtelo de nuevo",
                "accountNotFound": "Cuenta del destinatario no encontrada",
                "accountNotInitialized": "La cuenta del destinatario aún no ha sido activada en la red",
                "insufficientFundsForFee": "Fondos SOL insuficientes para la comisión de transacción",
                "customProgramError": "Error del programa (código: {{code}})",
                "transactionTooLarge": "La transacción es demasiado grande",
                "duplicateTransaction": "Esta transacción ya ha sido procesada",
                "simulationFailed": "La simulación de la transacción falló",
    ...
    "products": {
        ...
        "staking": {
            ...
            "subtitle": {
                "join": "Gana hasta {{apy}}% con {{tokenName}}",
            ...
            "pools": {
                ...
                "liquidDescription": "Envía GRAM a staking y obtén tokens wsTON en su lugar",
            ...
            "transfer": {
                ...
                "notEnoughCoinsFee": "No hay suficientes GRAM en el saldo de tu billetera para pagar la tarifa. Ten en cuenta que la tarifa de {{amount}} GRAM debe estar en el saldo principal, no en el saldo de staking",
            ...
            "join": {
                ...
                "earn": "Gana hasta",
                "onYourTons": "en tus GRAMs",
                "apy": "13.3%",
                "yearly": "APY",
                "cycle": "Obtén recompensas por staking cada 36h",
                "ownership": "Los GRAMs en staking siguen siendo tuyos",
                "withdraw": "Retirar y recargar en cualquier momento",
                "successTitle": "{{amount}} GRAM en staking",
                "successEtimation": "Tus ganancias anuales estimadas son {{amount}}\u00A0GRAM\u00A0(${{price}}).",
                "successNote": "Tus GRAM en staking se activarán una vez que comience el próximo ciclo."
            },
            "pool": {
                "balance": "Stake total",
                "members": "Nominadores",
            ...
            "unstakeLiquid": {
                ...
                "message": "Puedes retirar fondos directamente después de que finalice el ciclo o intercambiar instantáneamente wsTON por GRAM en "
            },
            "unstakeLiquidUsde": {
            ...
            "info": {
                ...
                "depositFeeDescription": "Cantidad de GRAM que se deducirá del monto del depósito para cubrir las tarifas de la acción de depósito, la cantidad no utilizada se devolverá al saldo de tu billetera",
                "withdrawFeeDescription": "Cantidad de transferencia de GRAM necesaria para cubrir las tarifas de la acción de retiro, la cantidad no utilizada se devolverá al saldo de tu billetera",
                "withdrawCompleteDescription": "Cantidad de transferencia de GRAM necesaria para cubrir las tarifas de la acción de finalización de retiro, la cantidad no utilizada se devolverá al saldo de tu billetera",
            ...
            "minAmountWarning": "La cantidad mínima es {{minAmount}} GRAM",
            "tryAgainLater": "Por favor, intenta de nuevo más tarde",
            "banner": {
                "estimatedEarnings": "Tus ganancias anuales estimadas disminuirán en {{amount}}\u00A0GRAM\u00A0({{price}})",
        ...
        "holders": {
            ...
            "card": {
                ...
                "defaultSubtitle": "Paga con USDT o GRAM en todas partes con tarjeta",
            ...
            "enroll": {
                ...
                "ledger": {
                    "confirmTitle": "Continuar con Ledger",
                    "confirmMessage": "Firme la autorización y confirme la dirección de la cartera"
                }
            },
            "otpBanner": {
            ...
            "banner": {
                ...
                "dogsTitle": "DOGS ahora soportado",
                "dogsSubtitle": "Carga fácilmente tu tarjeta con DOGS",
            },
            "dogsbanner": {
                "subtitle": "Personaliza tu tarjeta con DOGS y paga en todo el mundo con funciones adicionales.",
                "action": "Personalizar tu tarjeta",
            },
            "transaction": {
                "type": {
            ...
            "noDirectDeposit": {
                "warningTitle": "El depósito directo no es compatible",
                "alertTitle": "Actualizamos el contrato",
                "alertDescription": "Por favor, crea una nueva cuenta y transfiere todos tus fondos y tarjetas a ella. Es más seguro y admite depósitos directos",
                "buttonTitle": "Crear una nueva cuenta"
            },
            "dogsInvite": {
                "title": "Comienza con tu tarjeta DOGS",
                "subtitle": "Puedes abrir tu tarjeta DOGS aquí y recargarla directamente con DOGS. Configuración rápida, financiación fácil — todo en un solo lugar."
            }
        }
    },
    "welcome": {
    ...
    "neocrypto": {
        ...
        "title": "Compra GRAM con tarjeta de crédito por USD, EUR y RUB",
    ...
    "known": {
        ...
        "withdraw": "Solicitud de retiro de {{coins}} GRAM",
        ...
        "holders": {
            ...
            "accountTopUp": "Recarga de cuenta de {{amount}} GRAM",
    ...
    "spamFilter": {
        "minAmount": "Cantidad mínima de GRAM",
        "dontShowComments": "No mostrar comentarios en transacciones SPAM",
        "minAmountDescription": "Las transacciones con una cantidad de GRAM menor a {{amount}} se marcarán automáticamente como SPAM",
    ...
    "deleteAccount": {
        ...
        "description": "Esta acción eliminará todos los datos y la billetera actualmente seleccionada de este dispositivo y tu cuenta en la blockchain\nNecesitas transferir todas tus monedas GRAM a otra billetera. Antes de continuar, asegúrate de tener más de {{amount}} GRAM en tu cuenta para completar la transacción",
        ...
        "confirm": {
            ...
            "message": "Esta acción eliminará tu cuenta y todos los datos de esta aplicación y transferirá todas tus monedas GRAM a la dirección de la billetera que especificaste.\nPor favor, verifica cuidadosamente la dirección del destinatario antes de continuar. Se cobrará una tarifa estándar de blockchain por esta transacción."
        },
    ...
    "hardwareWallet": {
        ...
        "errors": {
            ...
            "openApp": "Por favor, abre la aplicación Ton en tu Ledger",
            ...
            "permissionsIos": "Por favor, permite el acceso a Bluetooth"
        },
        "moreAbout": "Más sobre Ledger",
        "verifyAddress": {
            "title": "Confirmar dirección en Ledger",
            "message": "Por favor, confirme la dirección: {{address}} en su dispositivo Ledger",
            "action": "Confirmar",
            "invalidAddressTitle": "Dirección inválida",
            "invalidAddressMessage": "Esta dirección no es válida. Por favor, verifique la dirección y vuelva a intentarlo",
            "failed": "Error al confirmar la dirección",
            "failedMessage": "Por favor, reconecte Ledger y vuelva a intentarlo",
            "verifying": "Confirmar en Ledger",
            "validAddressTitle": "Esta dirección es válida"
        }
    },
    "devTools": {
        "switchNetwork": "Red",
    ...
    "newAddressFormat": {
        ...
        "description_3": "Todos los GRAMs, tokens, NFTs y otros activos enviados a tu antigua dirección seguirán llegando a tu billetera.",
    ...
    "order": {
        ...
        "networkServiceFee": "Comisión de red y servicio",
        "serviceFee": "Comisión de servicio",
        "poweredBy": "Desarrollado por",
        "continue": "Continuar",
        "sendToDeposit": "Envía {{currency}} para depositar en tu cuenta",
        "waitingTransfer": "Esperando transferencia...",
        "amount": "Cantidad",
        "address": "Dirección",
        "network": "Red",
        "youSend": "Envías",
        ...
        "deposit": "Depósito",
        "waitingForTransfer": "Esperando transferencia",
        "chooseCrypto": "Elegir cripto",
        "chooseAsset": "Elige el activo que quieres recibir:",
        "orderCloseTitle": "¿Estás seguro de que quieres cerrar esta orden?",
        "orderCloseDescription": "Una vez que se cierre la orden, cualquier fondo ya enviado a la dirección proporcionada se perderá permanentemente y no podrá ser recuperado.\n\nSi estás experimentando algún problema o tienes preguntas, por favor contacta a nuestro equipo de soporte.",
        "orderCloseConfirm": "Sí, acepto cerrar la orden",
        "contactSupport": "Contactar soporte",
        "info": {
            "title": {
                "pending": "Depósito en camino",
                "success": "Depósito exitoso",
                "failure": "Depósito fallido"
            },
            "description": {
                "pending": "Pago recibido. La recarga tomará de 5 minutos a 10 horas.",
                "success": "Crypto en tu cuenta",
                "failure": "Pago fallido. Por favor contacta al soporte"
            },
            "notifications": {
                "amountCopiedSuccess": "Cantidad copiada exitosamente",
                "payAddressCopiedSuccess": "Dirección copiada exitosamente",
                "orderClosedSuccess": "Orden cerrada exitosamente"
            },
            "status": {
                "pending": "En camino",
    ...
    "w5": {
        ...
        "update": {
            ...
            "description_1": "Ya no necesitas GRAM para enviar USDT. Las tarifas de transacción pueden cubrirse con tu saldo de tokens.",
        ...
        "gaslessInfo": "No se requiere GRAM para pagar la tarifa de gas al enviar este token. La tarifa se deducirá directamente de tu saldo de tokens."
    },
    "savings": {
        "ton": "Cuenta de ahorro GRAM",
        "usdt": "Cuenta de ahorro USDT",
        "general": "Cuenta de ahorro {{symbol}}"
    },
    "spending": {
        "ton": "Cuenta de gasto GRAM",
        "usdt": "Cuenta de gasto USDT",
        "general": "Cuenta de gasto {{symbol}}"
    },
    "solana": {
        "instructions": {
            "createAssociatedTokenAccount": "Crear ATA",
            ...
            "executeWithdrawal": "Ejecutar retiro",
            "cancelWithdrawal": "Cancelar retiro",
            "allocateWithdrawals": "Asignar retiros",
            "deleteCard": "Eliminar tarjeta",
            "updateCardStateV2": "Actualizar estado de tarjeta",
            "createRoot": "Crear root",
            "issueCard": "Emitir tarjeta",
            "refund": "Reembolso",
            "syncCardBalance": "Sincronizar saldo de tarjeta",
            "updateCardState": "Actualizar estado de tarjeta",
            "withdrawFromTreasure": "Retirar del tesoro",
            "addToWhitelist": "Agregar a la lista blanca",
            "removeFromWhitelist": "Eliminar de la lista blanca",
            "resetWhitelist": "Restablecer lista blanca",
            "changeController": "Cambiar controlador",
            "changeGracefulPeriod": "Cambiar período de gracia",
            "assignNewTreasureAuthority": "Asignar nueva autoridad del tesoro",
            "setSupportAuthority": "Establecer autoridad de soporte",
            "setWithdrawalConfig": "Establecer configuración de retiro",
            "fixIncorrectDeposit": "Corregir depósito incorrecto",
            "instruction-12": "Transferencia"
        },
        "banner": {
            "title": "Solana está disponible",
            "description": "Recibe, almacena y envía SOL y USDC"
        }
    },
    "iban": {
        "banner": {
    ...
    "walletRequests": {
        "title": "Quiere enviarte fondos, confirma que esta es tu dirección",
        "description": "Si el propietario de esta dirección usa Tonhub, puedes solicitarles que verifiquen que esta es la dirección correcta y le pertenece",
        "request": "Solicitar confirmación",
