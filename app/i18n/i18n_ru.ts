...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    transfer: {
        ...
        aboutFeesDescription: 'Комиссии за транзакции в блокчейне зависят от нескольких факторов: загруженности сети, размера транзакции, цены газа и конфигурационных параметров блокчейна. Чем выше спрос на обработку транзакций в блокчейне или больше размер транзакции (сообщение/комментарий), тем выше будут комиссии.',
    },
    auth: {
