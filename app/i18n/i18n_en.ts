...
const schema: PrepareSchema<LocalizationSchema, '' | '_plural'> = {
    ...
    mandatoryAuth: {
        ...
        action: 'Enable',
        settingsDescription: 'Authentication request is required as the app displays banking products. Sensative data will be hidden until you turn the authentication on',
    }
};
