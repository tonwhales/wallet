...
const knownWalletsTestnet = {
    ...
    [Address.parse('kQDBKeGhu9nkQ6jDqkBM9PKxBhGPLEK9Zzj-R2eP8jXK-8Pk').toString({ testOnly: true })]: {
        name: 'Test KOTE',
        colors: {
            primary: '#3595D3',
            secondary: '#BAD5E7'
    ...
    [Address.parse('0QBfAN7LfaUYgXZNw5Wc7GBgkEX2yhuJ5ka95J1JJwXXf2Dz').toString({ testOnly: true })]: {
        name: 'OKX',
        ic: Img_OKX
    },
