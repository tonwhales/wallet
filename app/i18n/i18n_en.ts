...
const schema: PrepareSchema<LocalizationSchema, '' | '_plural'> = {
    ...
    newAddressFormat: {
        ...
        shortDescription: 'Addresses update will make the TON blockchain more stable. All assets sent to the old address will continue flowing to your wallet.',
        description_0_0: 'Recently, TON ',
        description_0_link: 'announced the addresses update',
        description_0_1: ' and asked all wallets to support it.',
        title_1: 'Why?',
        description_1: 'The update allows developers to distinguish wallets and contracts addresses and avoid errors when sending transactions.',
        title_2: 'What do you need to do?',
        description_2: 'Click the button on the previous screen and authorize us to display all addresses in the app in the new format. You will be able to revert back to the old format in the settings.',
        title_3: 'What happens to the old address?',
        description_3: 'All TONs, tokens, NFTs and others sent to the old address will continue to flow to your wallet unchanged.',
