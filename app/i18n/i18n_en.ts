...
const schema: PrepareSchema<LocalizationSchema, "" | "_plural"> = {
    ...
    "sign": {
        ...
        "hint": "No funds would be transfered to the app and no access to your coins would be granted.",
        "action": "Sign",
        "binary": "Binary payload message",
        "binaryData": "Binary data",
        "cellSchema": "Cell schema",
        "cellData": "Cell data"
    },
    "migrate": {
    ...
    "products": {
        ...
        "holders": {
            ...
            "dogsbanner": {
                "subtitle": "Customize your card with DOGS and pay worldwide with extra features.",
                "action": "Customize your card",
            },
            "transaction": {
                "type": {
            ...
            "dogsInvite": {
                "title": "Start with your DOGS card",
                "subtitle": "You can open your DOGS card here and top it up directly with DOGS. Fast setup, easy funding — all in one place."
            }
        }
    },
    "welcome": {
    ...
    "hardwareWallet": {
        ...
        "verifyAddress": {
            ...
            "validAddressTitle": "This address is valid"
        }
    },
    "devTools": {
    ...
    "update": {
        ...
        "forceDescription": "This version of Tonhub is no longer supported. Update the app to continue.",
        "forceSupport": "Contact support"
    },
    "savings": {
    ...
    "solana": {
        "instructions": {
            ...
            "allocateWithdrawals": "Allocate withdrawals",
            "deleteCard": "Delete card",
            "updateCardStateV2": "Update card state",
            "createRoot": "Create root",
            "issueCard": "Issue card",
            "refund": "Refund",
            "syncCardBalance": "Sync card balance",
            "updateCardState": "Update card state",
            "withdrawFromTreasure": "Withdraw from treasure",
            "addToWhitelist": "Add to whitelist",
            "removeFromWhitelist": "Remove from whitelist",
            "resetWhitelist": "Reset whitelist",
            "changeController": "Change controller",
            "changeGracefulPeriod": "Change graceful period",
    ...
    "aiChat": {
        ...
        "welcomeSubtitle": "Ask about your expenses or request advice",
        "placeholder": "Type a message...",
        "characterCount": "{{count}}/1000",
        "recoveringRequest": "Recovering request...",
        "clearHistory": "Clear history",
        "reconnect": "Reconnect",
        "messageTooLong": "Message too long. Maximum 1000 characters allowed.",
        "notConnected": "Not connected to chat server",
        "loadingProfile": "Loading profile...",
        "profileNotAvailable": "Profile not available. Please check your Holders account.",
        "errors": {
            "certificateError": "Certificate validation failed. Check server SSL configuration.",
