...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    transfer: {
        ...
        aboutFeesDescription: 'Комиссии за транзакции в блокчейне могут варьироваться в зависимости от нескольких факторов: загруженность сети, размер транзакции, цена за газа и конфигурационных параметров блокчейна. В целом, чем выше спрос на обработку транзакций в блокчейне, тем выше будут комиссии. Аналогично, чем больше размер транзакции (сообщение/комментарий транзакции) тем выше будут комиссии.',
    },
    auth: {
