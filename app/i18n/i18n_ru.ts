...
const schema: PrepareSchema<LocalizationSchema, '_0' | '_1' | '_2'> = {
    ...
    secure: {
        ...
        subtitle: 'Мы используем пароль подтверждения транзакций что бы быть уверенными что никто кроме вас не сможет перевести ваши монеты.',
        ...
        subtitleFaceID: 'Подключите Face ID',
        subtitleBiometrics: 'Подключите биометрию'
    },
    backup: {
    ...
    confirm: {
        ...
        passcode: {
            change: {
                ...
                positive: 'Изменить пароль'
            },
            turnOff: {
                title: 'Вы уверены, что хотите отключить аутентификацию по паролю?',
                message: 'Настоятельно рекомендуется включить пароль на вашем устройстве для защиты ваших активов.',
                positive: 'Отключить пароль'
            }
        },
        biometry: {
            turnOff: {
                title: 'Вы уверены, что хотите отключить {{type}} аутентификацию?',
                message: 'Настоятельно рекомендуется включить биометрию на вашем устройстве для защиты ваших активов.',
                positive: 'Отключить {{type}} аутентификацию',
                typeBiometry: 'биометрическую'
            }
        }
    }
};
